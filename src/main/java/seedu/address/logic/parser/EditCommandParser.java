...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            ParserUtil.parseEducationLevel(argMultimap.getValue(PREFIX_EDUCATION_LEVEL))
                    .ifPresent(editPersonDescriptor::setEducationLevel);
            ParserUtil.parseSchool(argMultimap.getValue(PREFIX_SCHOOL)).ifPresent(editPersonDescriptor::setSchool);
