...
public class ModelManagerTest {
    ...
    public void equals() {
        ...
        // different task filteredList -> returns false
        String[] keywordsT = EXAMPLE1.getDescription().split("\\s+");
        modelManager.updateFilteredTaskList(new TaskContainsKeywordsPredicate(Arrays.asList(keywordsT)));
        assertFalse(modelManager.equals(new ModelManager(addressBook, userPrefs)));
